...
import com.arrahtec.dataquality.core.ColumnData;
import com.arrahtec.dataquality.core.ColumnPrivilegesData;
import com.arrahtec.dataquality.core.ColumnProfile;
import com.arrahtec.dataquality.core.ColumnStore;
import com.arrahtec.dataquality.core.Columnprivileges;
import com.arrahtec.dataquality.core.CreateTable;
import com.arrahtec.dataquality.core.DataDictionary;
import com.arrahtec.dataquality.core.DataDictionaryData;
import com.arrahtec.dataquality.core.DataTypeMetadata;
import com.arrahtec.dataquality.core.DbVolume;
import com.arrahtec.dataquality.core.DeleteRow;
import com.arrahtec.dataquality.core.DeleteRowData;
import com.arrahtec.dataquality.core.ExecuteQuery;
import com.arrahtec.dataquality.core.ExecuteQueryData;
import com.arrahtec.dataquality.core.FreqStats;
import com.arrahtec.dataquality.core.Joins;
import com.arrahtec.dataquality.core.Merge;
import com.arrahtec.dataquality.core.StringLenAnalysisWS;
import com.arrahtec.dataquality.core.Table;
import com.arrahtec.dataquality.core.TableDeDup;
import com.arrahtec.dataquality.core.TableDeDupData;
import com.arrahtec.dataquality.core.TableDeltaCondn;
import com.arrahtec.dataquality.core.TableMetaData_data;
import com.arrahtec.dataquality.core.TablePrivilegesData;
import com.arrahtec.dataquality.core.TableServer;
import com.arrahtec.dataquality.core.TableStore;
import com.arrahtec.dataquality.core.TableVolume;
import com.arrahtec.dataquality.core.Table_Join;
import com.arrahtec.dataquality.core.Table_data;
import com.arrahtec.dataquality.core.TblRowCount;
import com.arrahtec.dataquality.core.Timeliness;
import com.arrahtec.dataquality.core.TimelinessAnalysisWS;
import com.arrahtec.dataquality.core.UpdateRow;
import com.arrahtec.dataquality.core.UpdateRowData;
import com.arrahtec.dataquality.core.Variation;
import com.arrahtec.dataquality.core.VolumeCount;
...
public class ReportService {
  ...
  private TableServer tableServer = new TableServer();

  @ApiParam(value = "Database Connection URI", required = true)
  @HeaderParam("OSDQ-connectionURI")
  ...
  public Response getTblName() {
    try {
      TableStore tbstore = new TableStore(connectionURI);
  ...
  public Response getClmData(
    ...
    try {
      ...
      ColumnStore clmname = new ColumnStore(table, connectionURI);
  ...
  public Response getTableData(
      ...
      @ApiParam(value = "Start point for which the data is to be fetched", required = true) @QueryParam("start") int start,
      @ApiParam(value = "Range for how many rows are to be fetched", required = true) @QueryParam("range") int range) {
    Table_data table_data = null;
    try {
      Table clm = tableServer.tableValues(table, 1, start, range,
          connectionURI);
  ...
  public Response getColumnData(
    ...
    try {
      clmdt = new ColumnData(table, column, connectionURI);
  ...
  public Response getTableMetaData(
    ...
    try {
      Table clm = tableServer.tableValues(table, 2, 0, 0, connectionURI);
  ...
  public Response getTableprivilegesData(
    ...
    try {
      Table clm = tableServer.tableValues(table, 3, 0, 0, connectionURI);
  ...
  public Response getColumnPrivilegesData(
    ...
    try {
      Columnprivileges clmdt = new Columnprivileges(table, column,
          connectionURI);
  ...
  public Response getTableDeDupData(
    ...
    try {
      TableDeDup clm = new TableDeDup(table, connectionURI);
  ...
  public Response delete_row(
    ...
    try {
      DeleteRow delRow = new DeleteRow(connectionURI, table, column, value,
          resp);
  ...
  public Response update(
    ...
    try {
      ...
      UpdateRow updateRow = new UpdateRow(connectionURI, table, column, value,
          columnCond, valueCond, resp);
  ...
  public Response execQuery(@QueryParam("query") String query) {
    ...
    try {
      ExecuteQuery exec = new ExecuteQuery(connectionURI, query);
  ...
  public Response getVolume() {
    try {
      DbVolume tblprv = new DbVolume(connectionURI);
  ...
  public Response getVolumeCount(
    ...
    try {
      ...
      tblprv.getVolumeCount(connectionURI, table, column, start, end);
      return Response.ok().entity(tblprv).build();
    } catch (Exception e) {
  ...
  public Response getColumnStats(
    ...
    try {
      ...
      FreqStats clmdt = new FreqStats(table, column, connectionURI);
      cllmname.add(clmdt);
      return Response.ok().entity(clmdt).build();
    } catch (Exception e) {
  ...
  public Response getvar(
    ...
    try {
      ...
      Variation clmdt = new Variation(table, column, connectionURI);
      cllmname.add(clmdt);
      return Response.ok().entity(clmdt).build();
    } catch (Exception e) {
  ...
  // @ApiOperation(value =
  // "Service to get the information about a data entry from two different
  // tables",
  ...
  // "com.arrahtec.prd.dataquality.Joins")
  ...
  public Response innerJoin(
    ...
    try {
      ...
      Joins JObj = null;
      JObj = new Joins(connectionURI, "inner");
      // TODO: chk if this is complete
  ...
  // "INPUT : Enter the table name and the column name in that table. "
  // +
  // "OUTPUT : Displays all the entries of the first table in addition to those
  // which are common to both the tables. ",
  // response = "com.arrahtec.prd.dataquality.Joins")
  // @ApiErrors({ @ApiError(code = 200, reason = "OK"),
  // @ApiError(code = 204, reason = "No Content"),
  // @ApiError(code = 400, reason = "Bad Request"),
  // @ApiError(code = 403, reason = "Forbidden"),
  ...
  public Response leftOuterJoin(
    ...
    try {
      Table_Join table_join = null;
      Joins JObj = null;
      JObj = new Joins(connectionURI, "leftouter");
      JObj.table_Join(table, "employee2", column);
      table_join = new Table_Join();
      table_join.setTable_Join(JObj);
      return Response.ok().entity(table_join).build();
  ...
  // "INPUT : Enter the table name and the column name in that table. "
  // +
  // "OUTPUT : Displays all the entries of the second table in addition to those
  // which are common to both the tables. ",
  // response = "com.arrahtec.prd.dataquality.Joins")
  // @ApiErrors({ @ApiError(code = 200, reason = "OK"),
  // @ApiError(code = 204, reason = "No Content"),
  ...
  public Response RightOuterJoin(
    ...
    try {
      Table_Join table_join = null;
      Joins JObj = null;
      JObj = new Joins(connectionURI, "rightouter");
      JObj.table_Join(table, "employee2", column);
      table_join = new Table_Join();
      table_join.setTable_Join(JObj);
      return Response.ok().entity(table_join).build();
  ...
  // = "com.arrahtec.prd.dataquality.Merge")
  // @ApiErrors({ @ApiError(code = 200, reason = "OK"),
  // @ApiError(code = 204, reason = "No Content"),
  // @ApiError(code = 400, reason = "Bad Request"),
  // @ApiError(code = 403, reason = "Forbidden"),
  ...
  public Response Merger(
    ...
    try {
      Table_Join table_join = null;
      Merge MObj = null;
      MObj = new Merge(connectionURI, "Name", "Vivek");
  ...
  public Response getTime(
      ...
      @ApiParam(value = "End Date", required = true) @PathParam("enddate") String end) {
    try {
      Timeliness tblprv = new Timeliness(connectionURI, table, column, start,
          end);
      return Response.ok().entity(tblprv).build();
    } catch (Exception e) {
  ...
  public Response gettableVolume(
    ...
    try {
      ...
      tblvlm.getTable_Volume(connectionURI, table);
  ...
  public Response dictionaryPDF(@Context HttpServletResponse servletResponse) {
    try {
      ...
      DataDictionary dataDictionary = new DataDictionary(connectionURI,
  ...
  // @ApiOperation(value = "Service to load bulk data from csv to database",
  // httpMethod = "GET", response = LoadAnalysis.class)
  // @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  // public Response loadAnalysis(
  // @ApiParam(value = "File Path from which data is to be loaded.This should
  // contain only data and not the table headers", required = true)
  // @PathParam("path") String path,
  // @ApiParam(value = "Table name to which data is to be loaded", required =
  // true) @PathParam("table") String table,
  // @Context HttpServletResponse servletResponse) {
  // try {
  // LoadAnalysis loadAnalysis = new LoadAnalysis(connectionURI, path, table);
  ...
  public Response deltaTableData(
      ...
      @Context HttpServletResponse servletResponse) {
    try {
      TableDeltaCondn deltaTableData = new TableDeltaCondn(connectionURI, table,
          condn);
  ...
  // TODO: To fix schema comparison
  // // 28.Schema Comparison
  // @GET
  // @Path("/schema_comparison/")
  // @ApiOperation(value = "Service to get table data based on a delta
  // condition", httpMethod = "GET", response = SchemaComparison.class)
  // @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
  // public Response schemaComparison(
  // @Context HttpServletResponse servletResponse) {
  // try {
  // String secDbStr =
  // "postgres/org.postgresql.Driver/jdbc~postgresql/~localhost~5432~mydb/postgres/Infy123+";
  // SchemaComparison schemaCompare = new SchemaComparison(connectionURI,
  // secDbStr);
  ...
  public Response getTableRowCount(
      ...
      @Context HttpServletResponse servletResponse) {
    try {
      TblRowCount rowCnt = new TblRowCount(connectionURI, table);
  ...
  public Response getStringLenAnalysis(
      ...
      @Context HttpServletResponse servletResponse) {
    try {
      StringLenAnalysisWS strAnalysis = new StringLenAnalysisWS(connectionURI,
          table, column);
  ...
  public Response getTimelinessAnalysis(
      ...
      @Context HttpServletResponse servletResponse) {
    try {
      TimelinessAnalysisWS timeAnalysis = new TimelinessAnalysisWS(
          connectionURI, table, column);
  ...
  public Response createTable(
      ...
      @Context HttpServletResponse servletResponse) {
    try {
      CreateTable newTable = new CreateTable(connectionURI, table, column,
          isConstraint, constraintDesc);
  ...
  public Response dataTypeMetaData() {
    try {
      DataTypeMetadata dbType = new DataTypeMetadata(connectionURI);
