...
public class TableFirstInformation {
    ...
    public double getPatternCount(String tableName) throws SQLException {
        double patCount = 0;
     ...
     */
    public HashMap<String, Double> getTableProfile(String tableName) throws SQLException {
        double dupcount = 0;
     ...
     *
     */
    public int[] getTableFill(String tableName) throws Exception {
        int[] emptyCount = null;
